...
public class Zbicie extends Ruch {

    Figura zbitaFigura;

    public Zbicie(Plansza plansza, Figura figuraWykonujacaRuch, int wspolrzednaDocelowaRuchu, Figura zbitaFigura) {
        super(plansza, figuraWykonujacaRuch, wspolrzednaDocelowaRuchu);
        this.zbitaFigura = zbitaFigura;
    }
    ...
    public void egzekwujRuch() {
        ...
        plansza.kolekcjaWszystkichFigurNaPlanszy.remove(zbitaFigura);
